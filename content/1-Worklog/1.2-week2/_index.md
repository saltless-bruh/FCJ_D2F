...
- Attend Vietnam Cloud Day 2025 to learn about latest AWS services and cloud trends
- Research PKI/TLS certificate management best practices
- Refine project architecture with security-first approach
...
- **Attended Vietnam Cloud Day 2025** and gained insights into AWS IoT security best practices

- **PKI architecture designed** with 3-tier CA hierarchy (Root → Intermediate → Device)

- **Technical specifications documented** for certificate lifecycle management

- **Architecture diagram completed** showing Lambda automation, DynamoDB registry, and EventBridge orchestration
