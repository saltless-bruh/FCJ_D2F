...
{{% notice info %}}
Trong Tuần 5 của kỳ thực tập AWS First Cloud Journey (6-9 tháng 10, 2025), tôi đã dịch ba blog kỹ thuật AWS từ tiếng Anh sang tiếng Việt để làm cho nội dung kỹ thuật AWS có giá trị trở nên dễ tiếp cận cho các nhà phát triển Việt Nam và đóng góp cho cộng đồng điện toán đám mây Việt Nam đang phát triển.
{{% /notice %}}
